...
namespace Unity.Services.Qos
{
    static class Logger
    {
        const string k_Tag = "[QoS]";
        const string k_GlobalVerboseLoggingDefine = "ENABLE_UNITY_SERVICES_VERBOSE_LOGGING";
        const string k_VerboseLoggingDefine = "ENABLE_UNITY_QOS_VERBOSE_LOGGING";
        ...
        [Conditional(k_GlobalVerboseLoggingDefine), Conditional(k_VerboseLoggingDefine)]
