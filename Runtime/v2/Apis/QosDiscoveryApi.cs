...
namespace Unity.Services.Qos.V2.Apis.QosDiscovery
{
    ...
    internal interface IQosDiscoveryApiClient
    {
            ...
            /// Get all servers.
            /// </summary>
            /// <param name="request">Request object for GetAllServers.</param>
            /// <param name="operationConfiguration">Configuration for GetAllServers.</param>
            /// <returns>Task for a Response object containing status code, headers, and Models.QosServersResponseBody object.</returns>
            /// <exception cref="Unity.Services.Qos.V2.Http.HttpException">An exception containing the HttpClientResponse with headers, response code, and string of error.</exception>
            Task<Response<Models.QosServersResponseBody>> GetAllServersAsync(Unity.Services.Qos.V2.QosDiscovery.GetAllServersRequest request, Configuration operationConfiguration = null);
    ...
    internal class QosDiscoveryApiClient : BaseApiClient, IQosDiscoveryApiClient
    {
        ...
        /// <returns>Task for a Response object containing status code, headers, and Models.QosServersResponseBody object.</returns>
        /// <exception cref="Unity.Services.Qos.V2.Http.HttpException">An exception containing the HttpClientResponse with headers, response code, and string of error.</exception>
        public async Task<Response<Models.QosServersResponseBody>> GetAllServersAsync(Unity.Services.Qos.V2.QosDiscovery.GetAllServersRequest request,
